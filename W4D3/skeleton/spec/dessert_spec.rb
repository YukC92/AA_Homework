...
describe Dessert do
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredient = ["chocolate", "flour", "egg", "sugar"]
  ...
  describe "#eat" do
    ...
    it "raises an error if the amount is greater than the quantity" do
      expect { brownie.eat(100)}.to raise_error('not enough brownie to eat')
    end
  end

  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      allow(chef).to receive(:titleize).and_return("Chef Lemon the Greatest Cook")
      expect(brownie.serve).to eq("Chef Lemon the Greatest Cook has made 50 brownies!")
    end
  end
